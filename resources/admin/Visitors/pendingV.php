...
<head>
    ...
    <title>ZCJ Visitor Management System - Pending Visitors</title>
    <style>
        * {
...
<body>
            ...
            <table id="visitors-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button class="view-valid-id" data-id="1">View Valid ID</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="view-valid-id" data-id="2">View Valid ID</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="view-valid-id" data-id="3">View Valid ID</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="view-valid-id" data-id="4">View Valid ID</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.view-valid-id').forEach(button => {
                button.addEventListener('click', function () {
                    const id = this.getAttribute('data-id');
                    // Load the image based on ID (placeholder path)
                    idPhoto.src = `path/to/valid-id-${id}.jpg`;
